...
LOG="experiments/logs/objectnet3d_caffenet_rcnn_original_edge_boxes.txt.`date +'%Y-%m-%d_%H-%M-%S'`"
exec &> >(tee -a "$LOG")
...
time ./tools/test_net.py --gpu $1 \
  ...
  --net output/objectnet3d/objectnet3d_trainval/caffenet_fast_rcnn_original_objectnet3d_edge_boxes_iter_160000.caffemodel \
