...
LOG="experiments/logs/objectnet3d_vgg16_rcnn_view_selective_search.txt.`date +'%Y-%m-%d_%H-%M-%S'`"
exec &> >(tee -a "$LOG")
...
time ./tools/test_net.py --gpu $1 \
  ...
  --net output/objectnet3d/objectnet3d_trainval/vgg16_fast_rcnn_view_objectnet3d_selective_search_iter_160000.caffemodel \
