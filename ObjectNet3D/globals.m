...
% ObjectNet3D paths
path_objectnet3d = '/var/Projects/ObjectNet3D';
if exist(path_objectnet3d, 'dir') == 0
    path_objectnet3d = '/scail/scratch/u/yuxiang/ObjectNet3D';
end
opt.path_objectnet3d = path_objectnet3d;
